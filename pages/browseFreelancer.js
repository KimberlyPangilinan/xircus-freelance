  ...
  return (
    <div>
      ...
      <div style={{display:'flex',flexDirection:'column', gap:1,textAlign:'center'}}>
            <Heading m='0' p='0'>Freelancers Tavern</Heading>
            <Text  m='0' p='0'>Search for your freelancer</Text>
        </div>
                ...
                <TabPanel>
                    <div className="projectItems">
                        <FreelancerCard
                            ...
                            noOfWorksDone={"45"}
                            priceperhour={"0.02"}
                            description={"A full stack web developer specializing in Javascript and React framework"}
                        />
                        <FreelancerCard
